 ...
 *========================================================================
 */ 
class Points extends Curve{
    constructor(p,options){
        super(p,options) ;
        this._marker = readOption(options.marker, '*') ;
        this._xp = null ;
        this._yp = null ;
    }
    ...
    draw(x,y){
        ...
        this.context.beginPath() ;
        this.context.arc(this.Px(x),this.Py(y),10,0, Math.PI*2. );
...
class Plot{
    ...
    addPoints( opts={ name: "Points_"+this.noCurves,
                    color : this.color(this.noCurves) } ) {
        var nc = new Points(this,opts) ;
        this.curves.push(nc) ;
        this.init() ;
        return nc ;
    }
    ...
    addScatter(opts={name:"Scatter_"+this.scatters.length}){
        var s = new ScatteredPoints(this,opts) ;
